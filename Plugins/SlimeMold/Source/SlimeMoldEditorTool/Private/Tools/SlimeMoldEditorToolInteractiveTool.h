...
#include "SlimeMoldEditorToolInteractiveTool.generated.h"


/**
 * Builder for USlimeMoldEditorToolInteractiveTool
 */
UCLASS()
class SLIMEMOLDEDITORTOOL_API USlimeMoldEditorToolInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the USlimeMoldEditorToolInteractiveTool
 */
UCLASS(Transient)
class SLIMEMOLDEDITORTOOL_API USlimeMoldEditorToolInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	USlimeMoldEditorToolInteractiveToolProperties();
...
/**
 * USlimeMoldEditorToolInteractiveTool is an example Tool that allows the user to measure the
 ...
 */
UCLASS()
class SLIMEMOLDEDITORTOOL_API USlimeMoldEditorToolInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<USlimeMoldEditorToolInteractiveToolProperties> Properties;
