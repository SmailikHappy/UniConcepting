...
#include "SlimeMoldEditorToolInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "USlimeMoldEditorToolInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* USlimeMoldEditorToolInteractiveToolBuilder::BuildTool(const FToolBuilderState& SceneState) const
{
	USlimeMoldEditorToolInteractiveTool* NewTool = NewObject<USlimeMoldEditorToolInteractiveTool>(SceneState.ToolManager);
...
USlimeMoldEditorToolInteractiveToolProperties::USlimeMoldEditorToolInteractiveToolProperties()
{
...
void USlimeMoldEditorToolInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void USlimeMoldEditorToolInteractiveTool::Setup()
{
	...
	Properties = NewObject<USlimeMoldEditorToolInteractiveToolProperties>(this, "Measurement");
...
void USlimeMoldEditorToolInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit USlimeMoldEditorToolInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void USlimeMoldEditorToolInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void USlimeMoldEditorToolInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit USlimeMoldEditorToolInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void USlimeMoldEditorToolInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void USlimeMoldEditorToolInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void USlimeMoldEditorToolInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void USlimeMoldEditorToolInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
